...
<body bgcolor="#000000">
	...
	<ul>
		...
		<li class="active"><i class="fa-solid fa-phone"></i>&nbsp;<a href="contact.php">Contact Us</a></li>
    ...
    <div class="content">
      <div class="left-side">
        <div class="address details">
          ...
          <div class="text-one">Neoval,123</div>
          <div class="text-two">NewYork</div>
        </div>
        <div class="phone details">
          <i class="fas fa-phone-alt"></i>
          <div class="topic">Phone</div>
          <div class="text-one">+001 8078982842</div>
          <div class="text-two">+001 9526423046</div>
        </div>
        <div class="email details">
          <i class="fas fa-envelope"></i>
          <div class="topic">Email</div>
          <div class="text-one">neoval@gmail.com</div>
          <div class="text-two">info.neoval@gmail.com</div>
        </div>
      </div>
